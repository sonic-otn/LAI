...
typedef enum _lai_alarm_type_t
{
    ...
    LAI_ALARM_TYPE_EDFA_CURRENT_TOO_HIGH,
    LAI_ALARM_TYPE_MODULE_ABSENT,
    LAI_ALARM_TYPE_PLUGGABLE_BIASCURRENT_TOO_HIGH,
    LAI_ALARM_TYPE_PLUGGABLE_BIASCURRENT_TOO_LOW,
    LAI_ALARM_TYPE_PLUGGABLE_FAIL,
    LAI_ALARM_TYPE_PLUGGABLE_VCC_TOO_HIGH,
    LAI_ALARM_TYPE_PLUGGABLE_VCC_TOO_LOW,
    LAI_ALARM_TYPE_PUMP_TEMP_ABNORMAL,
    LAI_ALARM_TYPE_APR_TRIGGER,
